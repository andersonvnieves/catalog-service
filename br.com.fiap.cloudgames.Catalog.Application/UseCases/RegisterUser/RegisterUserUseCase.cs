...
namespace br.com.fiap.cloudgames.Catalog.Application.UseCases.User.RegisterUser;
...
public class RegisterUserUseCase
{
    ...
    public async Task<RegisterUserResponse> ExecuteAsync(RegisterUserRequest request)
    {
        try
        {
            ...
            var user = br.com.fiap.cloudgames.Catalog.Domain.Aggregates.User.Create(name, email, identityUserId);
